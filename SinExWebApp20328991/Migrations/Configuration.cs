namespace SinExWebApp20328991.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SinExWebApp20328991.Models.SinExDatabaseContext>
    {
        public Configuration()
        {
            ...
            ContextKey = "SinExWebApp20328991.Models.SinExDatabaseContext";
        }
        ...
        protected override void Seed(SinExWebApp20328991.Models.SinExDatabaseContext context)
        {
            ...
            context.PackageTypeSizes.AddOrUpdate(
             ...
             new PackageTypeSize { SizeInformation = "(Size:250x350mm; Weight Limit: Not Applicable)", PackageTypeID=1 },
             new PackageTypeSize { SizeInformation = "(Size:small - 350x400mm; Weight Limit: 5kg)", PackageTypeID = 2 },
             new PackageTypeSize { SizeInformation = "(Size:large - 450x550mm; Weight Limit: 5kg)", PackageTypeID = 2 },
             new PackageTypeSize { SizeInformation = "(Size:100x80mm; Weight Limit: Not Applicable)", PackageTypeID = 3 },
                new PackageTypeSize { SizeInformation = "(Size:small - 300x250x150mm; Weight Limit: 10kg)", PackageTypeID = 4},
                    new PackageTypeSize { SizeInformation = "(Size:medium - 400x350x250mm; Weight Limit: 20kg)", PackageTypeID = 4 },
                        new PackageTypeSize { SizeInformation = "(Size:large - 500x450x350mm; Weight Limit: 30kg)", PackageTypeID = 4 }
