...
namespace SinExWebApp20328991.Controllers
{
    public class PackageTypeSizesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PackageTypeSizeID,Size,WeightLimited,PackageTypeID")] PackageTypeSize packageTypeSize)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PackageTypeSizeID,Size,WeightLimited,PackageTypeID")] PackageTypeSize packageTypeSize)
        {
            if (ModelState.IsValid)
            {
